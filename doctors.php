...
<head>
    ...
    <title>Flowell Pharmacy - Find Pharmacist</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/pharmacist_on_duty.jpg" alt="Flowell Pharmacy">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="doctors">
            <input type="search" name="search" id="search" placeholder="Enter keywords, search doctors">
            <!-- <input type="submit" name="search_doctor" value="search"> -->
            <div class="doctors">
                <figure>
                    <img src="images/board_member.png" alt="Pharmacist">
                    <figcaption>
                        <h3>Pharm. Daniel E.</h3>
                        <p class="qual">FACS, FICS</p>
                        
                        <p><i class="fas fa-phone-volume"></i> +2347012345678</p>
                    </figcaption>
                </figure>
                <figure>
                    <img src="images/board_member.png" alt="Pharmacist">
