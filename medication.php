...
<head>
    ...
    <title>Flowell Pharmacy - Medication Administration</title>
...
<body>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="medication.php">Medication Administration</a></li>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/pharmacist_banner.jpg" alt="Flowell Pharmacy">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="ourServices">
            ...
            <div class="serv">
                <div>
                    <p>At Flowell Pharmacy, We have professional nurses and pharmacist that will help you with your current medication. From administering presciptions, drugs, etc to administering injectables, infussions, suturing, etc.<br>
