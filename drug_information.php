...
<head>
    ...
    <title>Flowell Pharmacy - Drug Information</title>
...
<body>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="drug_information.php">Drug Information</a></li>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/drugs2.jpg" alt="Flowell Pharmacy">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="ourServices">
            ...
            <div class="serv">
                <div>
                    <p>We have listed below our available drugs with their prices, presciption and information<br>
                    </p>
                </div>
                <div>
