...
<head>
    ...
    <title>Flowell Pharmacy - Drug Retail</title>
...
<body>
    ...
    <section class="top_head" id="topHeader">
        <div class="social_media">
            <p>
                <i class="fas fa-mobile"></i> <span>Call us </span>(+234) 905 397 7566
            </p>
        </div>
            ...
            <nav id="navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a class="active" href="retail.php"><i class="fas fa-vials"></i> Retail</a></li>
                    ...
                    <li><a href="recruitment.php" title="Job recruitment">Career</a></li>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/flowell_pharmacy_sales.jpg" alt="Flowell Pharmacy">
                    </div>
                    <div class="taglines">
                        <h2>Quality Drugs, Best prices</h2>
    ...
    <main>
        <section id="ourServices">
            ...
            <div class="serv">
                <div>
                    <p>At Flowell Pharmacy, we offer retail services of our pharmaceuticals and drugs at a very affordable price. Our drugs are of top quality with a distant expiration from day of purchase.<br>
                    Our Pharmacist are always on ground to help you with prescription and best advice on how to take the drug.
                    </p>
                    <img src="images/drugs.jpg" alt="Flowell pharmacy">
                    <div class="btns">
                        <a href="contact.php" title="contact us">Shop Now</a>
                    </div>
                </div>
                <div>
                    <p>We also provide you inforamtion on some of our drug category listed below<br>
                        <ul>
                            <li>Anti Malaria</li>
                            <li>Anti-biotics</li>
                            <li>Anti-hypertensive</li>
                            <li>Epileptic Drugs</li>
                            <li>CNS</li>
                            <li>Helmathinics</li>
                            <li>Anti-Fungal Drugs</li>
                            <li>Dermatology</li>
                            <li>Tussives</li>
                            <li>Anti-Ulcer</li>
                        </ul>
                    ...
                    <div class="btns">
                        <!-- <a href="#" title="contact us" class="showRequest" style="background:var(--secondaryColor);">Schedule and Appointment</a> -->
                        <a style="background:var(--secondaryColor);" href="drug_information.php">Find a Drug</a>
                    </div>
